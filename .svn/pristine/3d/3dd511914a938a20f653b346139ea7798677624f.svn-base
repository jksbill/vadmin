                ...
                <div class="widget-extra themed-background-dark">
                    <div class="widget-options">
                        <div class="btn-group btn-group-xs">
                            <a href="javascript:void(0)" class="btn btn-default" data-toggle="tooltip" title="" data-original-title="Edit Widget"><i class="fa fa-pencil"></i></a>
                            <a href="javascript:void(0)" class="btn btn-default" data-toggle="tooltip" title="" data-original-title="Quick Settings"><i class="fa fa-cog"></i></a>
                        </div>
                    </div>
                        ...
                        <ul class="timeline-list">
                            ...
                            <li class="active">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div id="gmap-timeline" class="gmap" style="height: 220px;"></div>
                                </div>
                            </li>
                            <li class="active">
