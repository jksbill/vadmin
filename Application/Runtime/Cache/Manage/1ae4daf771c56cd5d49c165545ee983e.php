<?php if (!defined('THINK_PATH')) exit();?><div class="row">
        <div class="col-sm-6 col-lg-3">
            ...
            <div class="widget">
                <div class="widget-simple">
                    <a href="javascript:;" class="widget-icon pull-left themed-background-autumn animation-fadeIn">
        ...
        <div class="col-sm-6 col-lg-3">
            ...
            <div class="widget">
                <div class="widget-simple">
                    <a href="/manage/index/test2" data="name=bill&age=32&job=coder" class="ajaxLink widget-icon pull-left themed-background-spring animation-fadeIn">
                        <i class="gi gi-usd"></i>
                    </a>
                    <h3 class="widget-content text-right animation-pullDown">
        ...
        <div class="col-sm-6 col-lg-3">
            ...
            <div class="widget">
                <div class="widget-simple">
                    <a href="javascript:;" class="widget-icon pull-left themed-background-fire animation-fadeIn">
        ...
        <div class="col-sm-6 col-lg-3">
            ...
            <div class="widget">
                <div class="widget-simple">
                    <a href="javascript:;" class="widget-icon pull-left themed-background-amethyst animation-fadeIn">
        ...
        <div class="col-sm-6">
            ...
            <div class="widget">
                <div class="widget-simple">
                    <a href="javascript:;" class="widget-icon pull-left themed-background animation-fadeIn">
